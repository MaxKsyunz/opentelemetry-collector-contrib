...
- Add a `replace` directive to `go.mod` files in the root directory, in `cmd/otelcontribcol`, and `cmd/configschema` so your component is included in the build of the contrib executable.
